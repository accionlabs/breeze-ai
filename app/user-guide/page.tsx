...
export default function Introduction() {
  return (
    <section className="docs-section">
      ...
      <p>Breeze.AI is an AI-led SDLC platform, powered by <strong>Semantic Engineering</strong>, built by <strong>Accion Labs</strong>. It accelerates both green-field (net-new) and brown-field (legacy modernization) software initiatives by capturing requirements, architecture, code, and design as a single connected <strong>Knowledge Graph</strong>, so traceability is preserved end-to-end, from business intent down to the line of code that implements it.</p>
      <p>Traditional software delivery loses traceability at every handoff. Requirements become a diagram when they reach the architect. That diagram becomes code that drifts from the blueprint when it reaches engineers. Meanwhile the design system evolves in Figma on its own schedule, disconnected from the running UI.</p>
      ...
      <div className="doc-table-wrap">
        <table className="doc-table">
          ...
          <tbody>
            <tr><td><strong>Product Owners</strong></td><td>Capture requirements once; the graph keeps them in sync with what&apos;s actually shipped.</td></tr>
